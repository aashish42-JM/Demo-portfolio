...
export default function AIAssistant() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="p-6 border-b border-[rgba(79,195,247,0.15)] flex items-center gap-4">
        <div className="relative">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#4fc3f7]/30 to-[#0a192f] flex items-center justify-center border border-[rgba(79,195,247,0.35)]">
            <Bot size={24} className="text-[#4fc3f7]" />
          </div>
          <div className="absolute -bottom-1 -right-1 w-4 h-4 rounded-full bg-green-500 border-3 border-[#050816]" />
        </div>
        <div>
          <h2 className="font-bold text-lg text-white">AashishAI</h2>
          <p className="font-mono text-xs text-[#4fc3f7]/70">Powered by Groq · llama-3.3-70b</p>
        </div>
        <div className="ml-auto flex items-center gap-2 px-4 py-2 rounded-full bg-green-400/10 border border-green-400/25">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-5">
        ...
        <AnimatePresence>
          {isLoading && (
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-[rgba(79,195,247,0.18)] border border-[rgba(79,195,247,0.25)] flex items-center justify-center">
                <Bot size={20} className="text-[#4fc3f7]" />
              </div>
              <div className="chat-ai px-4 py-3 flex items-center gap-2">
                {[0, 1, 2].map((i) => (
                  <motion.div
                    key={i}
                    className="w-2 h-2 rounded-full bg-[#4fc3f7]/70"
      ...
      {messages.length <= 1 && (
        <div className="px-6 pb-3">
          <div className="flex items-center gap-2 mb-3">
            <Sparkles size={14} className="text-[#4fc3f7]/60" />
      ...
      <div className="p-6 border-t border-[rgba(79,195,247,0.15)]">
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 px-4 py-3 rounded-2xl bg-[rgba(79,195,247,0.07)] border border-[rgba(79,195,247,0.25)]
          ...
          <button
            ...
            className="w-12 h-12 rounded-2xl bg-[rgba(79,195,247,0.18)] border border-[rgba(79,195,247,0.35)]
