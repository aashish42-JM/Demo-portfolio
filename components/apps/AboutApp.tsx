...
export default function AboutApp() {
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-10 space-y-10 scrollbar-thin scrollbar-thumb-[#4fc3f7]/40 scrollbar-track-transparent hover:scrollbar-thumb-[#4fc3f7]/60 transition-all duration-300">
        {/* Header */}
        <motion.div
        ...
        >
          ...
          <div className="relative shrink-0">
            <div className="w-40 h-40 rounded-3xl bg-gradient-to-br from-[#4fc3f7] to-[#0a192f] flex items-center justify-center border border-[rgba(79,195,247,0.3)] shadow-[0_0_40px_rgba(79,195,247,0.25)] overflow-hidden">
              <img
          ...
          <div className="flex-1 min-w-0 pt-2">
            <h1 className="text-4xl font-bold text-white mb-3">{PERSONAL.name}</h1>
            <p className="text-lg text-[#4fc3f7] font-mono mb-6">{PERSONAL.title}</p>
        ...
        >
          ...
          <p className="text-[#90caf9]/90 text-base leading-loose">{PERSONAL.bio}</p>
        </motion.div>
        ...
        <motion.div
          ...
          className="glass p-6 rounded-2xl border border-[rgba(79,195,247,0.15)]"
        >
          <h2 className="font-mono text-sm text-[#4fc3f7]/70 uppercase tracking-widest mb-6">
            // Connect
          </h2>
        ...
        <motion.a
          ...
          className="flex items-center justify-center gap-3 mx-auto max-w-md w-full py-5 rounded-2xl font-mono text-base
